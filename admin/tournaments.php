<?php 
  ...
  <body>
    ...
    <div class="container-fluid main-container">
      ...
      <?php 
                $req = $bdd->prepare('SELECT * FROM tournaments'); 
                $req->execute();

              while ($donnees=$req->fetch()) echo '
        <div class="panel panel-default">
          <div class="panel-heading">
            Tournament de '.$donnees['femme'].'
          </div>
          <div class="panel-body">
            <p>Statut '.$donnees['statut'].'</p>
                <p>  <a href="../fonctions/arreter_tournament.php?pseudo='.$donnees['femme'].'">Arreter ce tournament</a></p>
